...
if __name__ == "__main__":
    ...
    # Run code
    # Dataset config:
    # {'PRINT_CONFIG': True, 'GT_FOLDER': 'results/gt/', 'TRACKERS_FOLDER': 'results/trackers/',
    # 'OUTPUT_FOLDER': None, 'TRACKERS_TO_EVAL': ['exp12345_post'], 'CLASSES_TO_EVAL': ['pedestrian'],
    # 'BENCHMARK': 'MOT17', 'SPLIT_TO_EVAL': 'val', 'INPUT_AS_ZIP': False, 'DO_PREPROC': True,
    # 'TRACKER_SUB_FOLDER': 'data', 'OUTPUT_SUB_FOLDER': '', 'TRACKER_DISPLAY_NAMES': None,
    # 'SEQMAP_FOLDER': None, 'SEQMAP_FILE': None, 'SEQ_INFO': None,
    # 'GT_LOC_FORMAT': '{gt_folder}/{seq}/gt/gt.txt', 'SKIP_SPLIT_FOL': False}
