...
class Exp(MyExp):
    def __init__(self):
        ...
        self.val_ann = "/kaggle/working/datasets/MOT20/annotations/test.json"   # change to train.json when running on training set
        ...
        self.data_dir = '/kaggle/working/datasets/MOT20/images/val'
